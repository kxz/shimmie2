...
class Themelet {
	...
	public function display_permission_denied(Page $page) {
		...
		$this->display_error($page, "Permission Denied", "You do not have permission to access this page.  Perhaps you need to <a href='" . make_link("user_admin/login") . "'>log in</a>?");
	}
